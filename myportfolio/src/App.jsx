...
const projects = [
  ...
  { title: 'DPWH Website Mockup', type: 'Web', summary: 'A website for the Department of Public Works and Highways focused on clearer navigation and accessible service information.', stack: ['HTML', 'CSS', 'JavaScript'], status: 'Live Demo', link: 'https://dpwh.vercel.app/', preview: '/dpwh%20website%20preview.png' },
    ...
    <section id="home" className="hero-card reveal">
      ...
      <div className="hero-tools">
        <button
          ...
          onClick={toggleTheme}
        >
          <img className="theme-toggle-icon" src="/night-mode.png" alt="" aria-hidden="true" />
        </button>
      </div>
    </section>
